...
from numpy import arange, where, array, dot, outer, zeros, concatenate, ones, tile, mean, cov, eye, real, sqrt, diag, \
    fliplr, flipud
import numpy as np
...
if __name__ == '__main__':
    ...
    datafile = path.join(path.dirname(path.abspath(__file__)), "CORN.mat")
    ...
    MXtrain = MXcal[CalInd1];
    SXtrain = SXcal[CalInd1];
    Ytrain = Ycal[CalInd1]
